      ...
      <Box flex='1'>
          ...
          leftIcon={
            <Icon
              ...
              fill={
                classValue
                  ?
                  (classValue.startsWith('#') || classValue.startsWith('rgb'))
                    ?
                    classValue
                    :
                    // @ts-ignore
                    palette[classValue.split('-')[0]]?.[classValue.split('-')[1]]
                  : undefined
              }
            />
          }
            ...
            screenValue ? (
              <Icon
                ...
                onClick={(e) => {
                  ...
                  if (screenValue.startsWith('#') || screenValue.startsWith('rgb')) {
        ...
        >
          ...
          >
            {
              classValue ?
                <Text as='span' color='gray.400'>{classValue}</Text>
                :
              ...
              {Object.entries(palette).map(([color, values]) => (
                ...
                >
                  <>
                    ...
                    {Object.entries(values).map(([tone, hash], index) => (
                      <Box
                        key={color + '-' + tone + '-' + hash}
                      >
                        <Button
                          ...
                          bg={hash}
                          onMouseEnter={() => {
                            onMouseEnter(prefix + '-' + color + "-" + tone)
                          }}
